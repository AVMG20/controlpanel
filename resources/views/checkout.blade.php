            ...
            <form class="card p-4" method="POST">
                ...
                <div class="form-group mb-3">
                    ...
                    <select name="egg" class="form-control" id="egg" @change="updateSelectedEgg; ">
                        ...
                        <template x-for="egg in eggs">
                            <option :selected="egg.selected" x-text="egg.name" :value="egg.id"></option>
                        </template>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input x-model="name" @input="checkFormComplete()" name="name" id="name" type="text" class="form-control">
                </div>
        ...
        <div class="col-md-5 col-lg-4 order-md-last">
                ...
                <template x-if="selected_configuration?.name">
                    <li class="list-group-item d-flex flex-column ">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <span class="fw-bold" x-text="selected_configuration.price + selected_configuration.setup_price"></span>
                        </span>
                        </div>
                        <div>
            ...
            <template x-if="selected_location?.name">
                <div class="d-flex justify-content-center align-items-center">
                    <button :disabled="!form_complete" class="btn btn-primary">
                        {{__('Continue')}}
